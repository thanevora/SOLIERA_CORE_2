...
$title = ($reservation_type == 'event') ? 'Table Reservation' : 'Event Reservation';
$icon = ($reservation_type == 'event') ? '🍽️' : '🎉';
        ...
        <div class="lg:hidden card bg-primary text-white rounded-box shadow-2xl border border-accent transform transition-all duration-500 fade-in">
            ...
            <div class="card-body p-6">
                ...
                <div class="space-y-4">
                   ...
                   <?php if ($reservation_type == 'event'): ?>
                    <!-- Mobile -->
                    <a href="event_reservation_modal.php"
                    class="btn btn-outline btn-block border-accent text-accent hover:bg-accent hover:border-accent hover:text-primary rounded-btn py-3 font-bold lg:hidden">
                        <i class="fas fa-calendar-plus mr-2"></i> Book Another Event
                    </a>

                    <!-- Desktop -->
                    <a href="event_reservation_modal.php"
                    class="btn btn-outline flex-1 border-accent text-accent hover:bg-accent hover:border-accent hover:text-primary rounded-btn py-3 font-bold hidden lg:flex">
                        <i class="fas fa-calendar-plus mr-2"></i> Book Another Event
                    </a>
                <?php endif; ?>
            ...
            <div class="flex flex-col w-3/5 p-8 justify-between">
                ...
                <div class="space-y-4">
                    <div class="flex space-x-4">
                        ...
                        <a href="event_reservation_modal.php" class="btn btn-outline flex-1 border-accent text-accent hover:bg-accent hover:border-accent hover:text-primary rounded-btn py-3 font-bold">
                            <i class="fas fa-calendar-plus mr-2"></i> Book Another Event
                        </a>
                        <?php endif; ?>
                    </div>
